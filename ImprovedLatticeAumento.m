function [BER,SER] = ImprovedLatticeAumento(n_symbols , n_iterations , bits_all , n_all , H_all , par)
...
for loop1=1:n_iterations    
    ...
    for ind_db = 1:length(par.SNRdB_list)
        ...
        for loop2 = 1:n_symbols
            ...
            %% Melhora a Lattice AUMENTO Estimação                           
            opcion = 2;
            xhat_real = ImprovedLaticeAumento(H_real,par,s_real,w,opcion);

function [BER,SER] = LRdecimproved2(n_symbols , n_iterations , bits_all , n_all , H_all , par)
...
for loop1=1:n_iterations    
    ...
    for ind_db = 1:length(par.SNRdB_list)
        ...
        for loop2 = 1:n_symbols
            ...
            %% JUAN - From LR Aided Toward MLD in MIMO - Com Dois Elementos            
            xhat_real = LRdec_improved2(par,s_real,H_real,w);  %VOU ASSUMIR DOIS VALORES FIXOS
